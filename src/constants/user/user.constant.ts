...
export const UserFieldModelAuthorized = {
    [UserRole.user] : [...UserFieldModelRequired[UserRole.user], 'firstname', 'lastname', 'phone', 'birthday', 'height', 'weight', 'sex', 'picture'],
    [UserRole.superadmin] : [...UserFieldModelRequired[UserRole.superadmin], 'nickname', 'firstname', 'lastname', 'phone', 'birthday', 'height', 'weight', 'sex', 'picture']
}
...
export const UserRequestError = {
    ...
    ROLE_IS_INVALID : {success : false, data : null, message : "role is invalid", error : ApiError.USER_ROLE_IS_INVALID, status : HttpStatusCode.BadRequest} as IResponse,
    ...
    NICKNAME_IS_EMPTY : {success : false, data : null, message : "nickname can't be empty", error : ApiError.USER_NICKNAME_IS_EMPTY, status : HttpStatusCode.BadRequest} as IResponse,
    USERNAME_ALREADY_USED : {success : false, data : null, message : "username already used", error : ApiError.USER_USERNAME_ALREADY_USED, status : HttpStatusCode.BadRequest} as IResponse,
    ...
    UDPATE_ROLE : {success : false, data : null, message : "impossible to update role", error : ApiError.USER_UDPATE_ROLE, status : HttpStatusCode.BadRequest} as IResponse,
    USERNAME_CANT_BE_EMAIL : {success : false, data : null, message : "username can't be email", error : ApiError.USER_USERNAME_CANT_BE_EMAIL, status : HttpStatusCode.BadRequest} as IResponse,

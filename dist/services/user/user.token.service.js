...
class UserTokenService {
    static createToken(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (user) {
                ...
                data.expireAt = new Date(now.getTime() + 180 * date_constant_1.DateConstants.day);
                data.refreshExpireAt = new Date(now.getTime() + 365 * date_constant_1.DateConstants.day);
    ...
    static refreshTokenIsValid(token, refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (doc.refreshedAt && now.getTime() > doc.refreshedAt.getTime() + 1 * date_constant_1.DateConstants.day)

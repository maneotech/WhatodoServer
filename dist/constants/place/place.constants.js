...
exports.PlaceRequestError = {
    ...
    INVALID_REQUEST: { success: false, data: null, message: "invalid request place error", error: api_errors_constants_1.ApiError.PLACE_INVALID_REQUEST, status: httpstatuscode_constant_1.HttpStatusCode.InternalServerError },
};

...
exports.userRegisterRouter = void 0;
const async_express_service_1 = require("../../services/async-express.service");
const controllers = __importStar(require("../../controllers/user/user.register.controller"));
...
exports.userRegisterRouter = router;
/* ----------------------------------------------------------------- */
/* ----------------------------------------------------------------- */
/* ------------------------ MIDDLEWARE -------------------------- */
/* ----------------------------------------------------------------- */
...
//# sourceMappingURL=user.register.route.js.map